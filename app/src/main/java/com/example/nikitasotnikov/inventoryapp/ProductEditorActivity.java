...
public class ProductEditorActivity extends AppCompatActivity implements
    ...
    /** ImageView field to see image */
    private ImageView mProductImageView;

    /** ImageButton field to change image */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProductImageButton = (ImageButton) findViewById(R.id.edit_product_search_image_button);
...
//        values.put(ProductEntry.COLUMN_PRODUCT_NAME, nameString);
        ...
        if (mImageByteArray != null) {
            values.put(ProductEntry.COLUMN_PRODUCT_IMAGE, mImageByteArray);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_PICKER_CODE && resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ProductEditorActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }
        } else if (requestCode == IMAGE_PICKER_CODE) {
            Toast.makeText(ProductEditorActivity.this, "You haven't picked an image", Toast.LENGTH_LONG).show();
        }
    }
}
