...
public class ProductCatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Log.v("Click", "This is click");
                // Create new intent to go to {@link ProductEditorActivity}
                Intent intent = new Intent(ProductCatalogActivity.this, ProductDetailsActivity.class);
    ...
    private void deleteAllProducts() {
        ...
        Log.v("ProductCatalogActivity", rowsDeleted + " rows deleted from product database");
    }
